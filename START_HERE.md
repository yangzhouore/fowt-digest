...
The website is a static presentation layer over committed JSON. It does not run
the pipeline, query OpenAlex, collect engineering sources, deploy itself, or use
